...
func IdempotencyKey(v uuid.UUID) predicate.GiftRecord {
...
func IdempotencyKeyEQ(v uuid.UUID) predicate.GiftRecord {
	return predicate.GiftRecord(sql.FieldEQ(FieldIdempotencyKey, v))
}

// IdempotencyKeyNEQ applies the NEQ predicate on the "idempotency_key" field.
func IdempotencyKeyNEQ(v uuid.UUID) predicate.GiftRecord {
...
func IdempotencyKeyIn(vs ...uuid.UUID) predicate.GiftRecord {
...
func IdempotencyKeyNotIn(vs ...uuid.UUID) predicate.GiftRecord {
...
func IdempotencyKeyGT(v uuid.UUID) predicate.GiftRecord {
...
func IdempotencyKeyGTE(v uuid.UUID) predicate.GiftRecord {
...
func IdempotencyKeyLT(v uuid.UUID) predicate.GiftRecord {
...
func IdempotencyKeyLTE(v uuid.UUID) predicate.GiftRecord {
