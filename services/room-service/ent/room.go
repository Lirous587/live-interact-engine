...
type RoomEdges struct {
	// UserRoomRoles holds the value of the user_room_roles edge.
	UserRoomRoles []*UserRoomRole `json:"user_room_roles,omitempty"`
	// loadedTypes holds the information for reporting if a
	// type was loaded (or requested) in eager-loading or not.
	loadedTypes [1]bool
}

// UserRoomRolesOrErr returns the UserRoomRoles value or an error if the edge
// was not loaded in eager-loading.
func (e RoomEdges) UserRoomRolesOrErr() ([]*UserRoomRole, error) {
	if e.loadedTypes[0] {
		return e.UserRoomRoles, nil
	}
	return nil, &NotLoadedError{edge: "user_room_roles"}
}
...
func (*Room) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case room.FieldTitle, room.FieldDescription:
...
// QueryUserRoomRoles queries the "user_room_roles" edge of the Room entity.
func (_m *Room) QueryUserRoomRoles() *UserRoomRoleQuery {
	return NewRoomClient(_m.config).QueryUserRoomRoles(_m)
}
