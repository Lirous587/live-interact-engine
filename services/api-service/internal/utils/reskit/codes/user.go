...
var (
	...
	ErrUserIDInvalid     = ErrCode{Msg: "用户已存在", Type: ErrorTypeBadRequest, Code: 1004}
	...
	// OAuth相关错误 (1040-1059)
	ErrOAuthInvalidCode     = ErrCode{Msg: "无效的OAuth授权码", Type: ErrorTypeBadRequest, Code: 1040}
	ErrOAuthInvalidProvider = ErrCode{Msg: "不支持的OAuth提供商", Type: ErrorTypeBadRequest, Code: 1041}
	ErrOAuthUserInfoMissing = ErrCode{Msg: "OAuth用户信息缺失", Type: ErrorTypeBadRequest, Code: 1042}
	...
	ErrTokenFormatInvalid    = ErrCode{Msg: "Token格式无效", Type: ErrorTypeBadRequest, Code: 1062}
	ErrTokenExpired          = ErrCode{Msg: "Token已过期", Type: ErrorTypeUnauthorized, Code: 1063}

	ErrRefreshTokenMissingInHeader = ErrCode{Msg: "请求头中缺少RefreshToken参数", Type: ErrorTypeBadRequest, Code: 1070}
	...
	// 外部服务错误 (1080-1099)
	ErrGitHubAPIError = ErrCode{Msg: "GitHub API调用失败", Type: ErrorTypeBadGateway, Code: 1080}
	ErrGoogleAPIError = ErrCode{Msg: "Google API调用失败", Type: ErrorTypeBadGateway, Code: 1081}
)
